...
contract KFT is Context, IERC20, Ownable {
    ...
    string private _name = "Kaboom Finance Token";
    string private _symbol = "KFT";
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000 * 10**6 * 10**9;
